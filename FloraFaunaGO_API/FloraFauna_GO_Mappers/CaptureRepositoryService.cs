...
public class CaptureRepositoryService : ICaptureRepository<CaptureNormalDto, FullCaptureDto>
{
    private ICaptureRepository<CaptureEntities> Repository { get; set; }

    public CaptureRepositoryService(ICaptureRepository<CaptureEntities> repository)
    {
