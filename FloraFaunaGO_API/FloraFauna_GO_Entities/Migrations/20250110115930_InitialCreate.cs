        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Habitat_Espece_EspeceId",
                        column: x => x.EspeceId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EspeceId = table.Column<string>(type: "TEXT", nullable: false),
                    CaptureDetailsId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Localisation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Localisation_CaptureDetails_CaptureDetailsId",
                        column: x => x.CaptureDetailsId,
                        principalTable: "CaptureDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Localisation_Espece_EspeceId",
                        column: x => x.EspeceId,
                        principalTable: "Espece",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Habitat_EspeceId",
                table: "Habitat",
                column: "EspeceId");

            migrationBuilder.CreateIndex(
                name: "IX_Localisation_CaptureDetailsId",
                table: "Localisation",
                column: "CaptureDetailsId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Localisation_EspeceId",
                table: "Localisation",
                column: "EspeceId");

            migrationBuilder.CreateIndex(
                name: "IX_SuccesState_SuccesEntitiesId",
                table: "SuccesState",
                column: "SuccesEntitiesId");
